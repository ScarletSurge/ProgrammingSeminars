...
namespace DACS.HelloWorld.ViewModels
{

    internal sealed class OwnEnumerator
    {
    ...
    internal sealed class MVVMWindowViewModel : ViewModelBase, IDisposable
    {
        ...
        {
            // foreach (var item in new OwnEnumerator())
            // {
