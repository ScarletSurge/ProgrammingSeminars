...
/*
 * 1. Реализовать структуру ленивого динамического массива и функционал: создание/удаление внутренностей массива, добавление/удаление элемента, поиск первого вхождения элемента (то есть его индекса)
   2. Заполнить реализованный динамический массив данными из файла (путь к файлу - аргумент командной строки). Структура элемента (информация о производителе): id (int), название (char *) - динамическая строка, country (char *) - динамическая строка. После считывания удалить все вхождения производителей из страны "Test" у которых в названии есть подстрока "52".
 */
